...
This package provides the Noto Sans Mono nerd fonts. This is a reduced version
of the original package which contains additional font families. See 
[below](#nerd-fonts) for more details on the original source.
